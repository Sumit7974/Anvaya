...
function App() {
  ...
  const handleWorkerSelect = async (worker) => {
    try {
      ...
      if (!worker?._id) {
        throw new Error("Selected worker is missing a valid ID.");
      }
      ...
      const data = await apiRequest("/api/bookings", {
        ...
        token,
        body: {
          problemDescription: `Customer requested ${primarySkill} service.`,
          serviceTag: primarySkill,
          location: {
            type: "Point",
            coordinates,
          },
    ...
    <main className="min-h-screen bg-[#FFF1E6] text-slate-900">
      ...
      <section className="flex min-h-[calc(100vh-88px)] flex-col items-center justify-center px-6 pb-16 text-center">
        ...
        <p className="mt-6 max-w-2xl text-base leading-8 text-slate-600 sm:text-lg">
          ...
          painters, masons and other skilled professionals for your
          everyday needs.
        </p>
