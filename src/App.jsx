...
function App() {
  ...
  if (page === 'signup') return <Signup role={selectedRole} onSuccess={() => { if (selectedRole === 'customer') return setPage('translationVoice'); if (selectedRole === 'worker') return setPage('workerDashboard'); if (selectedRole === 'contractor') return setPage('contractorDashboard'); return setPage('adminDashboard'); }} onLogin={() => setPage('login')} onBack={back} />;
  ...
  if (page === 'workerProcess') return <WorkerProcess worker={selectedWorker} bookingId={bookingId} onBack={back} onRetryWorker={() => setPage('customerBooking')} onComplaint={() => setPage('complaintSubmission')} onProceedToPayment={() => setPage('customerPayment')} />;
